...
/**
 * a Class which uses an array to represent an image with colors between white (0) and black (255)
 */
public class Matrix
{
 /* Instance Varriables */
 ...
 * each matrix row is in a row, and each value in a row is seperated from the next by a tab
 ...
 */
 ...
 /**
 * returns a new matrix - with the negative of the current matrix image
