...
public class Stock
{
     ...
     * with it's prameters name, catalogueNumber, prod./expiry dates and quantity seperated by tab
    ...
    /** 
     * removes the quantity of first item found by its name, each name is a seperated string in the array.
    ...
    // removes the item at the index, and shifts all items after back to fill the gap
    ...
    private int findIndexToAddNew(long catalogueNumber) {
        ...
        // if it's the greatest (not smaller or equal) return the last filles index + 1= _noOfItems.
        return this._noOfItems;
    }
}